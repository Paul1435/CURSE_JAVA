...
public class Main {
    public static void main(String[] args) {
        ...
        Set<Dish> dishesPaul = new HashSet<>(Arrays.asList(
                new Dish("Блины", Dish.generateIngredients("Молоко", "Мука", "Яйцо"), Dish.Category.DESSERT, 80, 75, 275),
        ...
        Set<Dish> dishesPetr = new HashSet<>(Arrays.asList(
                new Dish("Блины", Dish.generateIngredients("Молоко", "Мука", "Яйцо"), Dish.Category.DESSERT, 79, 75, 275),
                ...
                new Dish("Суп", Dish.generateIngredients("Красная Вода", "мясо"), Dish.Category.HOT, 12, 13, 500)));
        ...
        Menu menu = new Menu(Weekday.MONDAY, 3, kingKitchen);
