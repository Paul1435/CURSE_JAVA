...
public class CoffeeMachine extends Product {
    private static final int[] typeCount = new int[CoffeeMachineType.values().length];
    ...
    public CoffeeMachine(double price, Dimensions size, CoffeeMachineType typeCoffeeMachine) {
